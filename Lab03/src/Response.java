...
public class Response {
    ...
    // ======================================
        ...
        String[] parametros_post = post_request.split(";\\|;");
            ...
            for (int i = 0; i < parametros_post.length ; i++) {

            }
        String from = parametros_post[0].substring(1).split(":")[1];
        String to = parametros_post[1].split(":")[1];
        String body = parametros_post[2].split(":")[1]+"\n"+parametros_post[3].split(":")[1];
//        String body = parametros_post[3].split(":")[1];
        LOGGER.info("FROMMMM: "+ from);
        LOGGER.info("TOOOOOO: "+ to);
//        LOGGER.info("SUBJECT: "+ subject);
        LOGGER.info("BODYYYY: "+ body);
        SMTPClient smtp = new SMTPClient(from, to, body);
        String[] toArray= {to};
        PrintWriter printwriter = smtp.start();
...
// Crear una instancia del cliente para usar un metodo y mandar al servidor
            ...
            smtp.sendMessage(printwriter, from, toArray, body);
        } else {
